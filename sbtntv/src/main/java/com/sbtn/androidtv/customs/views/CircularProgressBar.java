...
public class CircularProgressBar extends ProgressBar {
    ...
    private String colorDefaultNotFocus;
    ...
    protected void onFocusChanged(boolean gainFocus, int direction, Rect previouslyFocusedRect) {
        ...
        if (gainFocus) {
            mBackgroundColorPaint.setColor(getResources().getColor(R.color.white_tv));
        } else {
            mBackgroundColorPaint.setColor(Color.parseColor(colorDefaultNotFocus));
        }
    }
}
