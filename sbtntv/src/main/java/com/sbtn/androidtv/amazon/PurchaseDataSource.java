...
import com.sbtn.androidtv.amazon.AmazonIAPManager.PurchaseRecord;
...
public class PurchaseDataSource {
     ...
     *
     * @param receiptId amazon's receipt id
     * @param userId    amazon user id
     * @param status    the status for the purchase
     */
     ...
     *
     * @param receiptId amazon receipt id
     ...
     * @param fromStatus current status for the purchase record in table
     * @param toStatus   latest status for the purchase record
     * @return
     */
