...
public class FastDateFormat extends Format {
    ...
    /**
     * <p>Gets the time zone display groupName, using a cache for performance.</p>
     *
     ...
     * @return the textual groupName of the time zone
     */
        ...
        public final void appendTo(StringBuffer buffer, int value) {
            if (value < 100) {
                ...
                if (value < 1000) {
                    ...
                    if (value < 0) {
                        throw new RuntimeException("Negative values should not be possible"+ value);
                    }
    ...
    /**
     * <p>Inner class to output a time zone groupName.</p>
     */
