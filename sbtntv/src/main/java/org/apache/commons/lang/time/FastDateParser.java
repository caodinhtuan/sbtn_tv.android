...
public class FastDateParser implements DateParser, Serializable {
     ...
     */
    public FastDateParser(final String pattern, final TimeZone timeZone, final Locale locale, Date centuryStart) {
    ...
    private static class TimeZoneStrategy extends Strategy {
        ...
        /**
         * Index of zone groupId
         */
        private static final int ID = 0;
        /**
         * Index of the long groupName of zone in standard time
         */
        private static final int LONG_STD = 1;
        /**
         * Index of the short groupName of zone in standard time
         */
        private static final int SHORT_STD = 2;
        /**
         * Index of the long groupName of zone in daylight saving time
         */
        private static final int LONG_DST = 3;
        /**
         * Index of the short groupName of zone in daylight saving time
         */
        ...
        void setCalendar(final FastDateParser parser, final Calendar cal, final String value) {
            ...
            if(value.charAt(0)=='+' || value.charAt(0)=='-') {
                ...
                if(tz==null) {
                    throw new IllegalArgumentException(value + " is not a supported timezone groupName");
                }
            }
            cal.setTimeZone(tz);
        }
